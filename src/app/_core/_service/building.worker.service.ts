...
export class BuildingWorkerService {
  ...
  mappingUserWithBuilding(obj) {
    return this.http.post(`${this.baseUrl}BuildingWorker/MappingUserWithBuilding`, obj);
  }
  removeBuildingWorker(obj) {
    return this.http.post(`${this.baseUrl}BuildingWorker/RemoveBuildingWorker`, obj);
  }
  ...
  getAllBuildingWorkers() {
    return this.http.get(`${this.baseUrl}BuildingWorker/getAllBuildingWorkers`);
    }
  getBuildingWorkerByBuildingID(buildingID) {
    return this.http.get(`${this.baseUrl}BuildingWorker/GetBuildingWorkerByBuildingID/${buildingID}`);
    }
}
